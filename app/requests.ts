...
export async function requestChatStream(
  ...
  console.log("mmmmmmmmmmmmmmmmmmmm", messages);
  ...
  try {
    ...
    console.info(openaiUrl + "v1/chat/completions");
    ...
    if (res.ok) {
      ...
      while (true) {
        ...
        if (!content || !content.value) {
          ...
          const res = await fetch("http://openai.117w.com/openai.php", {
            method: "POST",
            headers: {
          ...
          console.info("done?", "结束");
          console.info("问题", messages);
          console.info("回答", responseText);
